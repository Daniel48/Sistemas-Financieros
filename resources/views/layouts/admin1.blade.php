...
<!-- Mirrored from wrappixel.com/demos/admin-templates/monster-admin/minimal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Sep 2018 16:12:01 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <button class="right-side-toggle waves-effect waves-light btn-info btn-circle btn-sm pull-right ml-2"><i class="ti-settings text-white"></i></button>
                        <button class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i> Create</button>
                        <div class="dropdown pull-right mr-2 hidden-sm-down">
            ...
            <!-- ============================================================== -->
            <footer class="footer">
                Sistemas de Información II - Sistema Financiero
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
...
<!-- Mirrored from wrappixel.com/demos/admin-templates/monster-admin/minimal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Sep 2018 16:13:04 GMT -->
</html>